...
class Main:
	...
	def draw_score(self):
		# with open (r'D:\User Files\Programming\.Projects\Snake-main\score.txt','r') as sc:
			# high_sc = sc.read()

		score_text = str(len(self.snake.body) - 3)
		# score_high_text = str("HI "+high_sc)
		score_surface = game_font.render(score_text,True,(56,74,12))
		# high_score_surface = game_font.render(score_high_text,True,(56,74,12))
		score_x = int(cell_size * cell_number - 60)
		score_y = int(cell_size * cell_number - 40)
		score_rect = score_surface.get_rect(center = (score_x,score_y))
		apple_rect = apple.get_rect(midright = (score_rect.left,score_rect.centery))
		bg_rect = pygame.Rect(apple_rect.left,apple_rect.top,apple_rect.width + score_rect.width + 6,apple_rect.height)
		# high_score_rect = high_score_surface.get_rect(center = (20,20))
		...
		# if int(score_text) > int(high_sc):
			# with open (r'D:\User Files\Programming\.Projects\Snake-main\score.txt','w') as sc:
				# sc.write(score_text)
...
apple = pygame.image.load(r'D:\User Files\Programming\.Projects\Snake-main\Graphics\apple.png').convert_alpha()
game_font = pygame.font.Font(r'.Projects\Snake-main\Font\PoetsenOne-Regular.ttf', 25)
